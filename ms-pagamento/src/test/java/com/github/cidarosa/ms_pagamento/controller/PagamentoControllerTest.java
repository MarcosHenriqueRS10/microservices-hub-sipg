...
public class PagamentoControllerTest {
    ...
    void setup() throws Exception {
        ...
        // Simulando o pagamento do serviço - updatePagamento
        // Id Existe
        ...
        // simulando o comportamento do serviço - deletePagamento
        // id exists
    ...
    @Test
    public void updatePagamentoShpuldReturnPagamentoDTOWhenIdExists() throws Exception{

        String jsonRequestBBody = objectMapper.writeValueAsString(dto);

        mockMvc.perform(put("/pagamentos/{id}", existingId)
                .content(jsonRequestBBody)
     ...
     @Test
    public void updatePagamentoShouldThrowResourceNotFoundExceptionWhenIdDoesNotExists() throws Exception{
     ...
     @Test
     @DisplayName("deletePagamento devera não fazer nada quando o id existe")
    public void deletePgamentoShouldDoNothingWhenIdExists() throws Exception{
